...
public class StateConfig {
	...
	public StateConfig(List<String> slotsNeeded,
	...
	public List<String> slotsNeeded() {
		return slotsNeeded;
	}

	public BiFunction<ConversationState, Map<String, String>, ActionResult> action() {
		return action;
	}

	public Function<ConversationState, ConversationState.Stage> nextState() {
		return nextState;
	}

	public Function<ConversationState, List<String>> suggestions() {
		return suggestions;
	}
}
