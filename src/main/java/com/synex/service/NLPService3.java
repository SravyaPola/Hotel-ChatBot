...
/**
 * Extracts exactly the named slots from free-form text, generates follow-up
 * questions, and renders action replies.
 */
public interface NLPService3 {
	/**
	 * Pull out exactly the given slot names from userMessage. Returns a map of
	...
	/**
	 * Given the structured result of an action, have the model render a 1–2
